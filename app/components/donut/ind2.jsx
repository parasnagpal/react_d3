...
class LiquidGauge extends React.Component{
      ...
      update(){
        ...
        function liquidFillGaugeDefaultSettings(){
            ...
            const gauge = d3.select(this.svgEl);
            ...
            const textRounder = function(value){ return Math.round(value); };
            ...
            const data = [];
            for(const i = 0; i <= 40*waveClipCount; i++){
        ...
        /*
            function GaugeUpdater(){
                this.update = function(value){
                    ...
                    const textRounderUpdater = function(value){ return Math.round(value); };
